...
#the chat model object is going to be our primary interface while interacting with llm and it is a standand way how langchain allows us to interact with these models

load_dotenv()

def main():
    print("Hello from langchain-course!")
    information="""Elon Reeve Musk is a businessman and entrepreneur known for his leadership of Tesla, SpaceX, X, and xAI. Musk has been the wealthiest person in the world since 2025; as of May 2026, Forbes estimates his net worth to be US$788 billion.
